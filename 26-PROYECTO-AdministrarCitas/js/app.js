...
class AdminCitas {
    ...
    mostrar() {
        ...
        this.citas.forEach(cita => {
            ...
            //con esto toma una copia completa del objeto 
            const clone = {...cita};
            btnEditar.onclick = ()=>{
                cargarEdicion(clone);
            }
            ...
            //se agrega contenedor para botones y se inserta en el html
...
function submitCita(e) {
    ...
    //limpiar el formulario luego de agregar un registro 
    formulario.reset();
    reiniciarObjetoCita();
